...
const Alumni = () => {
    ...
    return (
        <div className="px-[20px] md:px-[50px]">
            <SubHeading text="Meet some of " colourText="our alumni." />
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                {
                    alumni.map(c =>
                        <div key={Math.random() * 90} className="custom-border w-full flex flex-col ">
                            <div className="h-[212px] md:h-[277px] bg-no-repeat bg-cover bg-center grayscale overflow-hidden" style={{ backgroundImage: `url('${c.imgPath}')` }}></div>
